function NetDebugWindow() {
}

NetDebugWindow.prototype.Init = function (context) {
    $('#opendevpanel').click(function () {
        OpenDevToolsByID(_global.windowID);
    });

    this.NetDebug = new NetDebug(context);
...
function ReadyContext() {
    ...
    context.Event.on("Complete",function () {
        ...
        if(_global.debuggerWin == null) {
            _global.debuggerWin = new NetDebugWindow();
            _global.debuggerWin.Init(context);
        }
    });
