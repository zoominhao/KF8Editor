...
class KFDTable(pyKFDTable):
        ...
        while i < clscount:
            ...
            if rootkfdData is not None:
                ...
                if typedefinfo is None:
                    ...
                    typedefinfo["isinclude"] = rootkfd.isinclude
    ...
    # read from json file, and build mapping of id or name to class define
    def load_table(self, setting):
        ...
        if self.is_loaded:
            logging.warning("table already loaded")
            return
    ...
    # build mapping of export code path to group
