        ...
        enableDnd: function (jq, id) {
            if (!$('#treegrid-dnd-style').length) {
                $('head').append(
                    ...
                    '.treegrid-row-append .tree-title{border:1px solid #ff0000}' +
                    '</style>'
                );
            }
            return jq.each(function () {
                ...
                nodes.draggable({
                    ...
                    onBeforeDrag: function (e) {
                        // let row = getSourceRow(this);
                        // if (row.hasOwnProperty("allowDrag") == false || nodes.allowDrag == false) {
                        //     return false;
                        // }
                        if (opts.onBeforeDrag.call(target, getSourceRow(this)) == false) {
                            return false;
                        }
                ...
                view.add(nodes).droppable({
                    ...
                    onDragEnter: function (e, source) {
                        ...
                        var sRow = getSourceRow(source);
                        var dRow = getDestRow(this);
                        if (tr.length && dRow) {
                            cb();
                        }
                        ...
                        function cb() {
                            if (opts.onDragEnter.call(target, dRow, sRow) == false) {
                                ...
                                tr.removeClass('treegrid-row-none treegrid-row-append treegrid-row-top treegrid-row-bottom');
                    ...
                    onDragOver: function (e, source) {
                        ...
                        if (tr.length) {
                            ...
                            if (opts["uniqueParent"] == true) {
                                uniqueParentDragEnter(source, tr, sRow, dRow, nodeId, pageY, top, bottom);
                            } else {
                                internal_DragEnter(source, tr, pageY, top, bottom);
                            }
                    ...
                    onDrop: function (e, source) {
                        ...
                        if (tr.length) {
                            ...
                            dRow = getDestRow(tr);
                            if (tr.hasClass("treegrid-row-none")) {
                                tr.removeClass('treegrid-row-none treegrid-row-append treegrid-row-top treegrid-row-bottom');
                                return;
                            } else if (tr.hasClass('treegrid-row-append')) {
                                point = 'append';
                            } else {
                ...
                function internal_DragEnter(source, tr, pageY, top, bottom) {
                ...
                function uniqueParentDragEnter(source, tr, sRow, dRow, nodeId, pageY, top, bottom) {
                    if (pageY > top + (bottom - top) / 2) {
                        if (bottom - pageY < 5) {
                            if (sRow._parentId != dRow._parentId) {
                                allowDrop(source, false);
                                return false;
                            } else {
                                allowDrop(source, true);
                            ...
                            if (sRow._parentId == nodeId) {
                                allowDrop(source, true);
                                tr.addClass('treegrid-row-append');
                            } else {
                                allowDrop(source, false);
                                tr.addClass("treegrid-row-none");
                                return false;
                            }
                        }
                    } else {
                ...
                function getSourceRow(tr) {
                    return opts.getSourceRow(tr);
                }

                function getDestRow(tr) {
